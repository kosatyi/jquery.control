(function (global, factory) {
    ...
    const {compareArrays, forEach: forEach$2} = utils;
    const classes$1  = {};
    const controls = [];
    const ATTR = 'control';
    ...
    const {isArray,isPlainObject,forEach: forEach$1,sortObject} = utils;
    /**
     *
     * @type {{}}
     */
    ...
    const Router$1 = Class$1.createClass('router', {
        ...
        find: function (path,complete) {
            let route,result = Class$1.getClass('route', path);
            if( complete === true ){
                this.prepare();
            }
